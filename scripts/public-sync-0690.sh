#!/usr/bin/env bash
# Sync os-ui 0.6.90 to the PUBLIC repo (github.com/Data-Masterclass/sovereign-agentic-os).
...
PUBLIC_TIP=cb06a70          # current public main (0.6.81)
MSG="release: sync to os-ui 0.6.90 — refactors (0.6.89) + Software Design-stage UX (0.6.90)"
