#!/usr/bin/env bash
# Sync os-ui 0.6.105 to the PUBLIC repo (github.com/Data-Masterclass/sovereign-agentic-os).
# BUNDLES 0.6.90→0.6.105 (0.6.104 metric-tile fix + 0.6.105 Software stage restructure).
...
PUBLIC_TIP=b863cac          # current public main (0.6.103 — 0.6.104 sync never ran)
MSG="release: sync to os-ui 0.6.105 — Software builder stages (Define App · Design Epics · Create Context · Build App · Test & Publish) with real-progress gates + metric-tile clean-name fix"
