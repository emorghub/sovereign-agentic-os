#!/usr/bin/env bash
# Sync os-ui 0.6.96 to the PUBLIC repo (github.com/Data-Masterclass/sovereign-agentic-os).
# BUNDLES 0.6.90→0.6.96. Method: one clean public-line commit whose TREE == private HEAD
...
PUBLIC_TIP=fff566e          # current public main (0.6.88)
MSG="release: sync to os-ui 0.6.96 — durable OS-side app-records store behind os.records.* (app-internal writes persist, envelope-gated, My/Domain scoped)"
