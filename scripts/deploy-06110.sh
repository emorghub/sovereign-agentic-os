...
IMG=ghcr.io/aborek/sovereign-os/os-ui:0.6.110
...
echo "==> helm upgrade (pinned to 0.6.110@$DIGEST)"
...
helm -n agentic-os upgrade agentic-os charts/sovereign-agentic-os \
  ...
  --set softwareBuild.enabled=true \
  --set softwareBuild.namespace=agentic-apps \
  --set osUI.image.tag="0.6.110@$DIGEST"
