#!/usr/bin/env bash
# One-shot guarded deploy of os-ui 0.6.103 — Software data-resolution (0.6.101) + builder self-serve go-live (0.6.102) + Big Bet component fixes (0.6.103).
...
#   0.6.103 Software runs the reasoning model on ALL stages incl. Build
...
IMG=ghcr.io/aborek/sovereign-os/os-ui:0.6.103
...
echo "==> helm upgrade (pinned to 0.6.103@$DIGEST)"
...
helm -n agentic-os upgrade agentic-os charts/sovereign-agentic-os \
  ...
  --set osUI.image.tag="0.6.103@$DIGEST"
