#!/usr/bin/env bash
# Sync os-ui 0.6.86 to the PUBLIC repo (github.com/Data-Masterclass/sovereign-agentic-os).
...
MSG="release: sync to os-ui 0.6.86 — curated-from-own-data, metric & dashboard fixes, picker UX, docs+MCP truth-sync"
