#!/usr/bin/env bash
# One-shot guarded deploy of os-ui 0.6.140 — teach the Software build agent the vendored-app
...
IMG=ghcr.io/aborek/sovereign-os/os-ui:0.6.140
...
echo "==> helm upgrade (pinned to 0.6.140@$DIGEST)"
...
helm -n agentic-os upgrade agentic-os charts/sovereign-agentic-os \
  ...
  --set osUI.image.tag="0.6.140@$DIGEST"
