#!/usr/bin/env bash
# Sync os-ui 0.6.88 to the PUBLIC repo (github.com/Data-Masterclass/sovereign-agentic-os).
...
PUBLIC_TIP=e867d88          # current public main (0.6.81)
MSG="release: sync to os-ui 0.6.88 — codebase cleanup (0.6.87) + security/governance hardening (0.6.88)"
