#!/usr/bin/env bash
# One-shot guarded deploy of os-ui 0.6.87 (behavior-preserving cleanup wave)
...
IMG=ghcr.io/aborek/sovereign-os/os-ui:0.6.87
...
echo "==> helm upgrade (pinned to 0.6.87@$DIGEST)"
...
helm -n agentic-os upgrade agentic-os charts/sovereign-agentic-os \
  ...
  --set osUI.image.tag="0.6.87@$DIGEST"
