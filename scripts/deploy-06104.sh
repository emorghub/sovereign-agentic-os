...
#   0.6.104 Software runs the reasoning model on ALL stages incl. Build
...
IMG=ghcr.io/aborek/sovereign-os/os-ui:0.6.104
...
echo "==> helm upgrade (pinned to 0.6.104@$DIGEST)"
...
helm -n agentic-os upgrade agentic-os charts/sovereign-agentic-os \
  ...
  --set osUI.image.tag="0.6.104@$DIGEST"
