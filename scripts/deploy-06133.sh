#!/usr/bin/env bash
# One-shot guarded deploy of os-ui 0.6.133 — teach the Software build agent the vendored-app
...
IMG=ghcr.io/aborek/sovereign-os/os-ui:0.6.133
...
echo "==> helm upgrade (pinned to 0.6.133@$DIGEST)"
...
helm -n agentic-os upgrade agentic-os charts/sovereign-agentic-os \
  ...
  --set osUI.image.tag="0.6.133@$DIGEST"
