#!/usr/bin/env bash
# One-shot guarded deploy of os-ui 0.6.95 — BUNDLES 0.6.90→0.6.95:
...
#   0.6.95 Software runs the reasoning model on ALL stages incl. Build
...
IMG=ghcr.io/aborek/sovereign-os/os-ui:0.6.95
...
echo "==> helm upgrade (pinned to 0.6.95@$DIGEST)"
...
helm -n agentic-os upgrade agentic-os charts/sovereign-agentic-os \
  ...
  --set osUI.image.tag="0.6.95@$DIGEST"
