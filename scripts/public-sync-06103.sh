#!/usr/bin/env bash
# Sync os-ui 0.6.103 to the PUBLIC repo (github.com/Data-Masterclass/sovereign-agentic-os).
# BUNDLES 0.6.90→0.6.103. Method: one clean public-line commit whose TREE == private HEAD
...
PUBLIC_TIP=93dedbf          # current public main (0.6.100)
MSG="release: sync to os-ui 0.6.103 — Software data-resolution (bind/create datasets), builder self-serve go-live for own Personal app, Big Bet component fixes (names, Business Process, placeholders, software attach)"
