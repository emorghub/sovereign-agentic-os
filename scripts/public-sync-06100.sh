#!/usr/bin/env bash
# Sync os-ui 0.6.100 to the PUBLIC repo (github.com/Data-Masterclass/sovereign-agentic-os).
# BUNDLES 0.6.90→0.6.100. Method: one clean public-line commit whose TREE == private HEAD
...
PUBLIC_TIP=61a3b74          # current public main (0.6.98)
MSG="release: sync to os-ui 0.6.100 — fix baked dev-default-secret guard (instrumentation.register), Science Design columns+values, Science launch visibility + KServe diagnosis"
