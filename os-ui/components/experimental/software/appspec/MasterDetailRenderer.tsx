...
import { formatCell, resolveColumns } from '@/lib/experimental/software/appspec/render-logic.ts';
import type { MasterDetailConfig } from '@/lib/experimental/software/appspec/patterns.ts';
