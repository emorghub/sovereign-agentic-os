...
import { PATTERNS, isImplementedPattern, type PatternId } from '@/lib/experimental/software/appspec/patterns.ts';
import { parseAppSpec, ROLE_GATES, THEME_CSS_MAX, CUSTOM_HTML_MAX, CUSTOM_CSS_MAX, CUSTOM_JS_MAX, type StoryRef } from '@/lib/experimental/software/appspec/schema.ts';
import { describeApp } from '@/lib/experimental/software/appspec/describe.ts';
import { buildStageAffordance, shouldAutoGenerate } from '@/lib/experimental/software/appspec/build-affordance.ts';
import { parseFunctions } from '@/lib/experimental/software/appspec/functions-schema.ts';
import {
  initialState,
  stateFromSpec,
  composeSpec,
  ...
  setFunctions,
  type ComposeState,
} from '@/lib/experimental/software/appspec/compose-model.ts';
import {
  slotsFor,
  isComposable,
  isBespoke,
  ...
  extractColumnNames,
  type ComposeSlot,
} from '@/lib/experimental/software/appspec/compose-fields.ts';
import {
  newMetricCard,
  cardSource,
  setCardLabel,
  ...
  setAggField,
  setExpr,
} from '@/lib/experimental/software/appspec/compose-blocks.ts';
import {
  locateIssues,
  issuesForTab,
  issuesForSlot,
  ...
  hasBlockingErrors,
  type LocatedIssue,
} from '@/lib/experimental/software/appspec/compose-issues.ts';
import type { AppSpec, CustomBody, FieldType, TableColumn, FormField } from '@/lib/experimental/software/appspec/schema.ts';
import type {
  PatternConfig,
  KpiCard,
  KpiOverviewConfig,
  ...
  ActionDetailConfig,
} from '@/lib/experimental/software/appspec/patterns.ts';
import type { AppFunction, AggOp } from '@/lib/experimental/software/appspec/functions-schema.ts';
