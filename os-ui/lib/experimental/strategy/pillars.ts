...
import {
  ...
  prevPillarScope,
  PILLAR_SCOPE_LABEL,
} from '@/lib/experimental/strategy/model';
import { auditStrategy } from '@/lib/experimental/strategy/audit';
...
import {
  ...
  type BetShare,
} from '@/lib/experimental/strategy/bets-bridge';
import { _setPillarId } from '@/lib/experimental/bigbets/store';
