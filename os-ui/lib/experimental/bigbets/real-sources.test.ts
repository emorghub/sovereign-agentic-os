...
import { createDataset, __resetStore as __resetData } from '@/lib/experimental/data';
import '@/lib/experimental/strategy/pillars'; // side-effect: pins the governed metric catalogue to globalThis
