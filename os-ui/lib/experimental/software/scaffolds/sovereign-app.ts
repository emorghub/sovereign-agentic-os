...
function templateSectionsTsx(): ScaffoldFile {
  return {
    ...
    content: [
      ...
      ' * AUTO-GENERATED on every commit from the story pages under',
      ' * src/epics/<epic>/<story>/<PascalCase>.tsx — do NOT hand-edit this file; your',
      ' * edits are overwritten. To add a feature section, just create its page:',
      ' *   Create src/epics/<epic>/<story>/<PascalCase>.tsx (default-export a component,',
      ' *   filename starts UPPERCASE, one page per story folder) and it is registered',
      ' *   here automatically. Shared/helper code goes in src/epics/<epic>/general/.',
      ' *',
...
export function sovereignAppGuide(name: string, slug: string): string {
  return [
    ...
    '| `src/template/sections.tsx` | **The section registry — AUTO-GENERATED on commit from the story pages; do not hand-edit.** One page per story folder. |',
    ...
    '   a React component, filename starts UPPERCASE, one page per story folder; use the',
    '   `@sovereign-os/ui` primitives — `Section`, `Card`, `Table`, `Badge`, `Button`).',
    '   Epic-wide shared code goes in `src/epics/<epic>/general/`.',
    '2. That is all — `src/template/sections.tsx` is auto-generated from these pages on every',
    '   commit (nav + routing pick it up automatically). Do NOT hand-edit sections.tsx.',
