...
import { emptyVersions, type Dataset } from '@/lib/experimental/data';
...
mock.module('@/lib/experimental/data/store', {
  namedExports: {
    listDatasets: () => ({
      mine: [],
...
mock.module('@/lib/experimental/connections/openmetadata', {
  namedExports: {
...
const { previewCatalogIngest, applyCatalogIngest } = await import('@/lib/experimental/connections/openmetadata-ingest.ts');
