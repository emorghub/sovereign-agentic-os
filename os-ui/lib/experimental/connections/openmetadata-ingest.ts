...
import type { OmSyncPreview, OmSyncResult } from '@/lib/experimental/connections/openmetadata-sync';
import type { OmDqPreview, OmDqSyncResult } from '@/lib/experimental/connections/openmetadata-dq';
