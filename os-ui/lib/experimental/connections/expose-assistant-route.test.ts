...
mock.module('@/lib/experimental/connections/store', {
  namedExports: {
...
mock.module('@/lib/experimental/connections/warehouse/catalog-snapshot', {
  namedExports: {
...
mock.module('@/lib/experimental/connections/warehouse/catalog-classification', {
  namedExports: {
...
mock.module('@/lib/experimental/connections/exposures', {
  namedExports: {
