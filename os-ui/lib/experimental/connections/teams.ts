...
import { type GraphConn, GRAPH_API, GRAPH_PAGE, GRAPH_MAX_PAGES, graphSend, type GraphResult } from '@/lib/experimental/connections/outlook';
...
export type { GraphConn } from '@/lib/experimental/connections/outlook';
