...
import { revokeExposureSet, updateExposureSet, allActiveExposures, type ExposureSet, type ExposureInput } from '@/lib/experimental/connections/exposures';
import { recompileExposures, exposureFqns, type ExposurePushResult } from '@/lib/experimental/connections/exposure-policy';
import { listAdoptions, revokeActionAdoption } from '@/lib/experimental/connections/action-adoptions';
import { removeLiveRegistration } from '@/lib/experimental/connections/warehouse/k8s-registration';
import { markDatasetsSourceRevoked } from '@/lib/experimental/data/store';
import { reconcileSyncCron } from '@/lib/experimental/data/sync-cron';
import { addNotification } from '@/lib/notifications/store';
import { trace } from '@/lib/infra/agent-governed';
import { config } from '@/lib/core/config';
import type { PhysicalTarget } from '@/lib/experimental/connections/connections-physical-delete';
