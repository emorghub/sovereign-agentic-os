 ...
 */
import 'server-only';
import type { Connection, ConnectionTool, CapabilityMode } from '@/lib/experimental/connections/schema';
import { config } from '@/lib/core/config';
import { isOperationalTemplate } from '@/lib/experimental/connections/operational-platform';
import { fetchWithBackoff } from '@/lib/experimental/connections/retry';
import { allActiveExposures, entityActionKey, type ExposureSet } from '@/lib/experimental/connections/exposures';
import { allActiveAdoptions, adoptionCovers, type ActionAdoption } from '@/lib/experimental/connections/action-adoptions';
import {
  salesforceConnFrom,
  sfToken,
  sfGetRecord,
  ...
  safeSObjectName,
  type SfConn,
} from '@/lib/experimental/connections/salesforce';
  ...
  try {
    switch (tool) {
      ...
      case SF_ACTION_TOOLS.search: {
        ...
        const { sfQuery } = await import('@/lib/experimental/connections/salesforce');
