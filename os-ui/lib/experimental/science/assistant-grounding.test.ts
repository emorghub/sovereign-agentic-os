...
mock.module('@/lib/experimental/data/dataset-schema', { namedExports: { LAYERS: ['bronze', 'silver', 'gold'] } });
const COLS = [
...
mock.module('@/lib/experimental/data/profile', {
  namedExports: {
    parseDescribe: () => COLS,
...
mock.module('@/lib/experimental/data/store-fqn', { namedExports: { slug: (s: string) => s.toLowerCase() } });
