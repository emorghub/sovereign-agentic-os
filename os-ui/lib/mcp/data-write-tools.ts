      ...
      properties: {
        ...
        picks: {
          ...
          items: {
            type: 'object',
            properties: {
              datasetId: { type: 'string', description: 'A dataset id you can READ — a governed asset/product, or your OWN personal (My-tier) dataset built to Silver/Gold.' },
