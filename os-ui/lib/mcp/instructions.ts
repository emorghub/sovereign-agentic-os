...
NAV (so you can orient the user): Entry (Home · Cockpit · Tutorials · MCP · About) · Plan (Strategy · Big Bets · Operating Model · Business Processes [also called: Workflows] · Marketplace) · Context (Knowledge · Files · Data · Connections · Metrics) · Build (Agents · Software · Science · Dashboards · Console) · Govern (Policies & Approvals · Monitoring · Components · LLM Gateway · Admin). There is no Settings tab and no separate personal (DuckDB) query engine — one governed Trino/Iceberg engine for everything.
